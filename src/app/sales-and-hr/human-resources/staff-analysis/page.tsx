      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-zinc-50 rounded-lg p-4 border border-zinc-200">
                <h3 className="text-sm font-semibold text-zinc-900 mb-3">Onsite Consultants</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-zinc-600">Total:</span>
                    <span className="font-semibold text-zinc-900 bg-orange-100 px-2 py-1 rounded text-sm">300</span>
                  </div>
                  <div className="space-y-2">
                    <p className="text-xs font-medium text-zinc-700 mb-2">Employee Types:</p>
                    <div className="flex items-center gap-2">
                      <FiCheck className="text-orange-500 shrink-0" size={12} />
                      <span className="text-xs text-zinc-600">Employees - To be provided</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <FiCheck className="text-orange-500 shrink-0" size={12} />
                      <span className="text-xs text-zinc-600">Freelancers - To be provided</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <FiCheck className="text-orange-500 shrink-0" size={12} />
                      <span className="text-xs text-zinc-600">Contractors - To be provided</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="bg-zinc-50 rounded-lg p-4 border border-zinc-200">
                <h3 className="text-sm font-semibold text-zinc-900 mb-3">Offsite Consultants</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-zinc-600">Total:</span>
                    <span className="font-semibold text-zinc-900 bg-blue-100 px-2 py-1 rounded text-sm">150</span>
                  </div>
                  <div className="space-y-2">
                    <p className="text-xs font-medium text-zinc-700 mb-2">Employee Types:</p>
                    <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-6">
          <div className="bg-white rounded-lg border border-zinc-200 p-6 shadow-sm">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-zinc-900 bg-blue-50 px-3 py-1 rounded-md text-sm">286</span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-zinc-900 bg-pink-50 px-3 py-1 rounded-md text-sm">114</span>
              </div>
            ...
            <p className="text-xs text-zinc-600 mt-2">Source: HR to provide</p>
          </div>
          ...
          <div className="bg-white rounded-lg border border-zinc-200 p-6 shadow-sm">
            ...
            <p className="text-sm text-zinc-500 mt-2">Annual</p>
            <p className="text-xs text-zinc-600 mt-2">Source: HR to provide</p>
          </div>
        </div>
