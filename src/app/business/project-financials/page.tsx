      ...
      <div className="max-w-7xl mx-auto ">
        ...
        <div className="bg-white rounded-xl border border-zinc-200 p-8 shadow-sm mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg p-6 border border-zinc-100">
              <div className="flex items-center gap-2 mb-4">
                <div className="p-1.5 bg-zinc-100 rounded-md">
                  <FiUsers className="text-[#fb5642] text-sm" />
                </div>
                <h3 className="text-base font-semibold text-zinc-900">Governance</h3>
              </div>
            ...
            <div className="bg-white rounded-lg p-6 border border-zinc-100">
              <div className="flex items-center gap-2 mb-4">
                <div className="p-1.5 bg-zinc-100 rounded-md">
                  <FiBarChart2 className="text-[#fb5642] text-sm" />
                </div>
                <h3 className="text-base font-semibold text-zinc-900">Tools & Tracking</h3>
              </div>
              <div className="space-y-3">
                <p className="text-sm text-zinc-600 leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg p-6 border border-zinc-100 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-base font-semibold text-zinc-900">Time & Material</h3>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-zinc-100">
                <p className="text-xs text-zinc-500 mb-1">Average Gross Margin</p>
            ...
            <div className="bg-white rounded-lg p-6 border border-zinc-100 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-base font-semibold text-zinc-900">Fixed Price</h3>
              </div>
              <div className="space-y-3 mb-4">
                <p className="text-sm text-zinc-600 leading-relaxed">
            ...
            <div className="bg-white rounded-lg p-6 border border-zinc-100 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-base font-semibold text-zinc-900">Work Packages</h3>
              </div>
              <div className="space-y-3 mb-4">
                <p className="text-sm text-zinc-600 leading-relaxed">
        ...
        <div className="bg-white rounded-xl border border-zinc-200 p-8 shadow-sm mb-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 border border-zinc-100">
              <h3 className="text-base font-semibold text-zinc-900 mb-4">A. Gross Margin Definition</h3>
            ...
            <div>
              <h3 className="text-base font-semibold text-zinc-900 mb-4">B. Costs Included in Gross Margin (Direct Costs)</h3>
              <div className="bg-white rounded-lg border border-zinc-200 overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="bg-zinc-50 border-b border-zinc-200">
                        <th className="px-6 py-4 text-left text-sm font-semibold text-zinc-900">Category</th>
                        <th className="px-6 py-4 text-left text-sm font-semibold text-zinc-900">Description</th>
                      </tr>
                    </thead>
                      ...
                      <tr className="hover:bg-zinc-50/50 transition-colors">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-zinc-900">Consultant & Employee Costs</span>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <p className="text-sm text-zinc-600 leading-relaxed">Salaries, benefits, and performance pay for delivery team members directly allocated to the project (Developers, QA, PMs, Architects, BAs, Designers).</p>
                        </td>
                      </tr>
                      <tr className="hover:bg-zinc-50/50 transition-colors">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-zinc-900">Subcontractor / Outsourcing Costs</span>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <p className="text-sm text-zinc-600 leading-relaxed">Vendor or partner costs associated with supplemental expertise or temporary staffing.</p>
                        </td>
                      </tr>
                      <tr className="hover:bg-zinc-50/50 transition-colors">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-zinc-900">Software Licenses & Tools</span>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <p className="text-sm text-zinc-600 leading-relaxed">Project-specific licenses, test environments, cloud usage, or design tool subscriptions.</p>
                        </td>
                      </tr>
                      <tr className="hover:bg-zinc-50/50 transition-colors">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-zinc-900">Travel & Onsite Costs</span>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <p className="text-sm text-zinc-600 leading-relaxed">Travel, accommodation, or client-site deployment expenses incurred for project execution.</p>
                        </td>
                      </tr>
                      <tr className="hover:bg-zinc-50/50 transition-colors">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-zinc-900">Infrastructure Utilization</span>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <p className="text-sm text-zinc-600 leading-relaxed">Dedicated hosting, servers, or VPN access costs assigned to the client engagement.</p>
                        </td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <div className="bg-white rounded-lg p-6 border border-zinc-100">
              <h3 className="text-base font-semibold text-zinc-900 mb-4">C. Costs Treated as Operating Expenses (Below Gross Margin)</h3>
              <div className="bg-white rounded-lg p-5 border border-zinc-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm text-zinc-600">Administration, HR, and Finance overheads</p>
                  </div>
                  <div className="flex items-start gap-2">
                    <FiCheckCircle className="text-[#fb5642] mt-0.5 shrink-0" />
                    <p className="text-sm text-zinc-600">Marketing and Sales operations</p>
                  </div>
                  <div className="flex items-start gap-2">
                    <FiCheckCircle className="text-[#fb5642] mt-0.5 shrink-0" />
                    <p className="text-sm text-zinc-600">Office rent, utilities, and infrastructure maintenance</p>
                  </div>
                  <div className="flex items-start gap-2">
                    <FiCheckCircle className="text-[#fb5642] mt-0.5 shrink-0" />
                    <p className="text-sm text-zinc-600">Training, R&D, and innovation costs</p>
                  </div>
                  <div className="flex items-start gap-2 md:col-span-2">
                    <FiCheckCircle className="text-[#fb5642] mt-0.5 shrink-0" />
                    <p className="text-sm text-zinc-600">Depreciation, corporate IT, and compliance costs</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg p-5 border border-zinc-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-semibold text-zinc-900">Monthly Reviews</h3>
              </div>
              <p className="text-sm text-zinc-600 leading-relaxed">
            ...
            <div className="bg-white rounded-lg p-5 border border-zinc-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-semibold text-zinc-900">Threshold Management</h3>
              </div>
              <p className="text-sm text-zinc-600 leading-relaxed">
            ...
            <div className="bg-white rounded-lg p-5 border border-zinc-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-semibold text-zinc-900">Data Integration</h3>
              </div>
              <p className="text-sm text-zinc-600 leading-relaxed">
